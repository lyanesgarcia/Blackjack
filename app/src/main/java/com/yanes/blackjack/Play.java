...
public class Play extends Activity implements View.OnClickListener {
    ...
    ArrayList<Card> my_ases_cards = new ArrayList<>();
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        game_money = intent.getIntExtra(MainActivity.SGameMoney, 0);
        total_money = intent.getIntExtra(MainActivity.STotalMoney, 0);
    ...
    public void back(){
        ...
        intent1.putExtra(MainActivity.SGameMoney, game);
